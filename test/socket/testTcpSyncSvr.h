#ifndef TEST_TCP_SYNC_SVR_H
#define TEST_TCP_SYNC_SVR_H
#include "../comm.h"
...
class __TestTcpSyncSvrRun : public IThreadRun
{
private:
...
void __testTcpSyncSvr()
{
	printf("\n__testTcpSyncSvr ---------------------------------------------------------\n");
	__initLog(ELogLevel_info);
	__TestTcpSyncSvrRun* r = new __TestTcpSyncSvrRun();
